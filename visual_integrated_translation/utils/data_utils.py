  ...
  if not gfile.Exists(vocabulary_path):
    ...
    with gfile.GFile(data_path, mode="r") as f:
      ...
      for line in f:
        ...
        tokens = tokenizer(line) if tokenizer else word_tokenize(line)
        for w in tokens:
...
def prepare_wmt_data(data_dir, en_vocabulary_size, ja_vocabulary_size, target_language):
  ...
  elif target_language == "ge":
      tokenizer = german_tokenizer
  print (tokenizer)

  # Create vocabularies of the appropriate sizes.
  ja_vocab_path = data_dir+ ("vocab{0}.{1}".format(ja_vocabulary_size,target_language) )
  en_vocab_path = data_dir + ("vocab%d.en" % en_vocabulary_size)
  create_vocabulary(ja_vocab_path, train_path + "."+target_language, ja_vocabulary_size, tokenizer=tokenizer)
  create_vocabulary(en_vocab_path, train_path + ".en", en_vocabulary_size, tokenizer=word_tokenize)

  # Create token ids for the training data.
  ja_train_ids_path = train_path + (".ids{0}.{1}".format(ja_vocabulary_size,target_language))
  en_train_ids_path = train_path + (".ids%d.en" % en_vocabulary_size)
  data_to_token_ids(train_path + "."+target_language, ja_train_ids_path, ja_vocab_path, tokenizer=tokenizer)
  data_to_token_ids(train_path + ".en", en_train_ids_path, en_vocab_path, tokenizer=word_tokenize)

  # Create token ids for the development data.
  ja_dev_ids_path = dev_path + (".ids{0}.{1}".format(ja_vocabulary_size,target_language))
  en_dev_ids_path = dev_path + (".ids%d.en" % en_vocabulary_size)
  data_to_token_ids(dev_path + "."+target_language, ja_dev_ids_path, ja_vocab_path, tokenizer=tokenizer)
  data_to_token_ids(dev_path + ".en", en_dev_ids_path, en_vocab_path, word_tokenize)
